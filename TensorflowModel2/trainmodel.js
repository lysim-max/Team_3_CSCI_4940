...
async function loadData() {
    ...
    try {
        ...
        if (connection) {
            const sql = `SELECT crn, credit_hours, fall_offered, spring_offered, summer_offered, area, difficulty, satisfied, prereq, recommended FROM class_list JOIN comp_sci ON crn_num=crn;`;
...
// Functions to encode categorical data
...
function createModel(inputShape) {
    ...
    model.compile({
        ...
        metrics: ['mse']  // Monitor mean squared error as a metric
    });
...
async function run() {
    ...
    await model.save('file:///Users/onlyt/Documents/GitHub/Team_3_CSCI_4940/TensorflowModel2');
